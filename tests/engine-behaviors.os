...
Процедура ТестДолжен_ПроверитьСравнениеНаБольшеМеньше() Экспорт
	...
	Ошибка = "Сравнение на больше/меньше для типа 'СтатусСообщения' не поддерживается";
	...
	Ошибка = "Сравнение на больше/меньше типов 'ЦветКонсоли' и 'СтатусСообщения' не поддерживается";
	юТест.ПроверитьКодСОшибкой(
		"Рез = (ЦветКонсоли.Черный < СтатусСообщения.БезСтатуса);",
		Ошибка, "Для значений перечислений разных типов" );

	Ошибка = "Сравнение на больше/меньше для типа 'ПеречислениеКодировкаТекста' не поддерживается";
	юТест.ПроверитьКодСОшибкой(
		"Рез = (КодировкаТекста >= КодировкаТекста);",
		Ошибка, "Для одинаковых перечислений" );
		
	Ошибка = "Сравнение на больше/меньше типов 'ПеречислениеХешФункция' и 'ПеречислениеСтатусСообщения";	
	юТест.ПроверитьКодСОшибкой(
		"Рез = (ХешФункция > СтатусСообщения);",
		Ошибка, "Для перечислений разных типов" );

	Ошибка = "Сравнение на больше/меньше для типа 'Тип' не поддерживается";
	юТест.ПроверитьКодСОшибкой(
		"Рез = (ТипЗнч(истина) > ТипЗнч(0));",
		Ошибка, "Для значений типа 'Тип'" );
		
	Ошибка = "Сравнение на больше/меньше типов 'Массив' и 'Структура' не поддерживается";
	юТест.ПроверитьКодСОшибкой(
		"Массив = Новый Массив(1);
		|Структура = Новый Структура;
	...
	Ошибка = "Сравнение на больше/меньше для типа 'Массив' не поддерживается";
	юТест.ПроверитьКодСОшибкой(
		"Массив = Новый Массив(1);
